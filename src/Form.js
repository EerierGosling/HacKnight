...
const Form = () => {
  useEffect(() => {
    ...
    if (!document.querySelector(`script[src="${widgetScriptSrc}"]`)) {
      ...
      script.onerror = () => console.error('The Tally script failed to load.');  // Handle script load errors
      document.body.appendChild(script);
    }
  }, []);

  return (
    <div style={{background:"white", width: "100vw", height: "100vh", overflow: "auto"}}>
      <iframe
