...
function IntroSection({image, title, text, index, column_width}) {
  ...
  return (
    <div className="section" style={{ display: "flex", alignItems: "center", justifyContent: "center", flexDirection: window.innerWidth < 1000 ? "column" : (index%2==0 ? "row-reverse" : "row"), width: column_width}} >
